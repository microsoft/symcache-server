...
If the server has a version 3.1.0 file cached, the client will prefer that to nothing, and will make a request to the
server without any If-Version-Exceeds request header.
